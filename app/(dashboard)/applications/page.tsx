    ...
    return (
        <div className="min-h-screen w-full p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {applications.map((applications: JobApplication) => (
                    <ApplicationCard key={applications.id} application={applications} />
                ))}
            </div>
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="bg-zinc-900 border-zinc-800 [&>button]:text-white [&>button]:hover:text-zinc-500 [&>button]:cursor-pointer">
                    ...
                    <form
                        onSubmit={(event) => handleCreate(event, selectedResumeId, jdRawText)}
                    ...
                    >
                        ...
                        <div className="flex gap-2">
                            <Button
                                type="submit"
                                className="flex-1 border-zinc-600 bg-zinc-800 text-zinc-400 hover:text-white hover:bg-zinc-700 cursor-pointer"
                            >
                                Submit
                            </Button>
                            <Button
