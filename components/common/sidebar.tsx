    ...
    return (
        <div className="flex flex-col h-screen w-64 bg-zinc-900 border-r border-zinc-800">
            ...
            <nav className="flex-1 px-3 py-4 space-y-1">
                <Link
                    href="/dashboard"
                    className={`flex items-center gap-3 px-4 py-2 ${pathname === "/dashboard" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
                >
                ...
                <Link
                    href="/resumes"
                    className={`flex items-center gap-3 px-4 py-2 ${pathname === "/resumes" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:text-white hover:bg-zinc-800"}`}
                >
                    <FileText size={18} />
                    <span>Resumes</span>
                </Link>
            ...
            <div className="mt-auto p-4 border-t border-zinc-800">
                ...
                <Button
                    ...
                    className="w-full border-zinc-700 text-zinc-400 hover:text-white hover:bg-zinc-800 flex items-center gap-2 cursor-pointer"
                >
                    <LogOut size={16} />
                    <span>Logout</span>
                </Button>
